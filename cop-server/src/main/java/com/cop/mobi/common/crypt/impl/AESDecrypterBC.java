...
import com.cop.mobi.common.crypt.AESDecrypter;
 ...
 * 
 */
public class AESDecrypterBC extends AESCryptBase implements AESDecrypter {

	public AESDecrypterBC(byte[] pwBytes, byte[] salt, byte[] pwVerification)
			throws ZipException {
